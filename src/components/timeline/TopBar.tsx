...
export function TopBar({ viewer }: TopBarProps) {
  return (
    <header className="sticky top-0 z-40 border-b border-white/5 bg-black/45 backdrop-blur-xl">
      <div className="mx-auto flex max-w-[1600px] items-center gap-4 px-4 py-3">
        ...
        <div className="ml-auto flex items-center gap-3">
          <IconButton aria-label="Notifications" className="h-10 w-10">
          ...
          >
            <div className="relative">
              <Avatar src={viewer.avatarUrl} alt={viewer.displayName} size={32} />
